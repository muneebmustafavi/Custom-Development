...
<div class="row">
			...
			<button type="button" class="btn btn-primary btn float-right mb-3" data-toggle="modal" data-target="#myModal">
				...
				<table class="table table-striped table-hover table-bordered my-4 order-table" id="myMemberTable">
					<?php include_once("includes/selectCategory.php")  ?>
				</table>
			</div>
		</div>
						...
						<div class="modal-body">
							...
							<div class="form-group">
								<div class="row">
									...
									<div class="col-lg-10">	
										<select class="form-control" id="sel1" name="categoryStatus">
							...
							<div class="form-group">
								<div class="row">
									...
									<div class="col-lg-10">
										<textarea class="form-control" rows="5" id="comment" name="categoryNote"></textarea>
									</div>
								</div>
							</div>
